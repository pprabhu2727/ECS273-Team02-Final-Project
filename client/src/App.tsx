...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Scroll to main content when species changes (except on initial load)
    const isInitialLoad = speciesList.length > 0 && selectedSpecies === speciesList[0];
    if (!isInitialLoad) {
      setTimeout(() => {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-gray-50">
      ...
      {selectedSpecies && (
        <div className="sticky top-0 z-50 px-4 py-4 bg-blue-100 w-full shadow-md">
          <div className="mx-auto grid grid-cols-3 items-center max-w-6xl">
      ...
      <div ref={mainContentRef} style={{ scrollMarginTop: '80px' }}>
  {loading ? (
    ...
    <div className="flex w-full">
      ...
      {/* Main Content - 80% */}
      <div className="w-[80%] flex flex-col space-y-8 pt-6">
        <section>
